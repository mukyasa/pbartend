 ...
 */
public class BookMarkArrayAdapter extends ArrayAdapter<BookmarkDomain> {
     ...
     * 
     */
    public BookMarkArrayAdapter(Context context, int textViewResourceId, List<BookmarkDomain> bookmarks) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		 Activity activity = (Activity) getContext();
	        ...
	        TextView rowView = (TextView) inflater.inflate(R.layout.bookmark_item, null);
