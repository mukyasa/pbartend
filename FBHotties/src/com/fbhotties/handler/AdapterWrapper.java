...
public class AdapterWrapper extends BaseAdapter {
	private BaseAdapter wrapped = null;
	private Context context;

	/**
	 * Constructor wrapping a supplied ListAdapter
	 */
	public AdapterWrapper(BaseAdapter wrapped) {
		super();

		this.wrapped = wrapped;
	}
	
	public AdapterWrapper(BaseAdapter wrapped,Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		HomeView cardset = (HomeView)wrapped.getItem(position);
