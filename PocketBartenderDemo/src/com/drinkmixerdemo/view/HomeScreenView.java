...
import com.drinkmixerdemo.dao.DrinkIngredientsInsert;
import com.drinkmixerdemo.dao.DrinkInserts;
...
public class HomeScreenView extends Activity implements OnClickListener,OnTouchListener,Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) { 
        ...
        dbfile = new File(Environment.getDataDirectory()+"/data/com.drinkmixerdemo/databases/", MixerDbHelper.DATABASE_NAME); 
